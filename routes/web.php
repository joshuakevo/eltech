...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('permission:manage settings')->group(function () {
        ...
        Route::post('settings/preview-nk00221-loan-term-fix', [SettingsController::class, 'previewNk00221LoanTermFix'])->name('settings.preview-nk00221-loan-term-fix');
        Route::post('settings/fix-nk00221-loan-term', [SettingsController::class, 'fixNk00221LoanTerm'])->name('settings.fix-nk00221-loan-term');
        Route::post('settings/preview-loan-rates-baseline-restore', [SettingsController::class, 'previewLoanRatesBaselineRestore'])->name('settings.preview-loan-rates-baseline-restore');
        ...
        Route::post('settings/preview-regenerate-legacy-schedules-balance', [SettingsController::class, 'previewRegenerateLegacyLoanSchedulesFromBalance'])->name('settings.preview-regenerate-legacy-schedules-balance');
        Route::post('settings/regenerate-legacy-schedules-balance', [SettingsController::class, 'regenerateLegacyLoanSchedulesFromBalance'])->name('settings.regenerate-legacy-schedules-balance');
        Route::post('settings/preview-regenerate-legacy-pending-installments', [SettingsController::class, 'previewRegenerateLegacyPendingInstallments'])->name('settings.preview-regenerate-legacy-pending-installments');
        ...
        Route::post('settings/preview-remove-august-legacy-repayments', [SettingsController::class, 'previewRemoveAugustLegacyRepayments'])->name('settings.preview-remove-august-legacy-repayments');
        Route::post('settings/remove-august-legacy-repayments', [SettingsController::class, 'removeAugustLegacyRepayments'])->name('settings.remove-august-legacy-repayments');
