                ...
                <form method="POST" action="{{ route('accounts.store') }}">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="number" name="default_withdrawal_charge" class="form-control" step="0.01" min="0" value="{{ old('default_withdrawal_charge') }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="default_institution_charge" class="form-control" step="0.01" min="0" value="{{ old('default_institution_charge') }}">
