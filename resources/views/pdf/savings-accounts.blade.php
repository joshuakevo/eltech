...
<div class="header clearfix">
    ...
    <h1>@php $_logo = \App\Models\SystemSetting::get('org_logo'); @endphp@if($_logo)<img src="{{ public_path($_logo) }}" style="height:32px;max-width:160px;object-fit:contain;vertical-align:middle">@else{{ \App\Models\SystemSetting::get('org_name', 'ElTech Finance') }}@endif — Savings Accounts</h1>
    <p>Sorted by balance, largest first</p>
</div>

<table class="summary-row">
    <tr>
        <td><span class="lbl">Number of Savers</span><span class="val">{{ number_format($totalSavers) }}</span></td>
        <td><span class="lbl">Total Savings</span><span class="val">{{ number_format($totalBalance, 0) }}</span></td>
    </tr>
</table>
...
<div class="footer">
    ElTech Finance &bull; Savings Accounts export
</div>
</body>
</html>
