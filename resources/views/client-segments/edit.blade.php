@extends('layouts.app')
@section('title','Edit Client Segment')
@section('content')
<div class="mb-4">
    ...
    <h4 class="mb-0 fw-semibold mt-1">Edit Segment — {{ $segment->name }}</h4>
</div>
...
<form method="POST" action="{{ route('client-segments.update', $segment) }}">
@csrf
@method('PUT')
<div class="row g-3">
    <div class="col-12">
    ...
    <div class="col-12">
        <div class="form-check form-switch">
            <input class="form-check-input" type="checkbox" name="is_active" id="is_active"
                   value="1" {{ old('is_active', $segment->is_active) ? 'checked' : '' }}>
