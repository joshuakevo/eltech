...
<div class="row justify-content-center">
    <div class="col-md-7">
        <div class="card">
            <div class="card-header">New Fixed Deposit Product</div>
            <div class="card-body">
                <form method="POST" action="{{ route('fd-products.store') }}">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-4">
                            ...
                            <input type="number" name="interest_rate" class="form-control" step="0.01" min="0" value="{{ old('interest_rate') }}" required>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-semibold">Term (months) <span class="text-danger">*</span></label>
                            <input type="number" name="term_months" class="form-control" min="1" value="{{ old('term_months') }}" required>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="deposit_liability_account_id" class="form-select ts-select">
                                ...
                                @foreach($accounts as $a)
                                    <option value="{{ $a->id }}" @selected(old('deposit_liability_account_id')==$a->id)>{{ $a->account_code }} — {{ $a->account_name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-md-6">
