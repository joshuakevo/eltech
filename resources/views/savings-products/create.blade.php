                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="interest_method" id="interestMethod" class="form-select">
                                <option value="flat"   @selected(old('interest_method','flat')=='flat')>Flat Rate</option>
                                <option value="tiered" @selected(old('interest_method')=='tiered')>Graduated Tiers</option>
                            </select>
                        </div>
                    </div>
                    <div class="row g-3 mb-3">
